...
@NoArgsConstructor
@Entity
@IdClass(WholeTrendOverviewId.class)
@Table(name = "t_whole_trend_overview")
public class WholeTrendOverview implements Serializable,Comparable<WholeTrendOverview> {
    /**
     * id  db_column: id
     */
    @Id
    ...
    @Override
    public int compareTo(WholeTrendOverview o) {
