...
@NoArgsConstructor
@Entity
@IdClass(WholeServiceOverviewId.class)
@Table(name = "t_whole_service_overview")
public class WholeServiceOverview implements Serializable,Comparable<WholeServiceOverview> {
    /**
     * id  db_column: id
     */
    @Id
    ...
    @Override
    public int compareTo(WholeServiceOverview o) {
        return dateSign.compareTo(o.getDateSign());
    }
}
