...
@Slf4j
public class FeedbackBackApiControllerTest {
    ...
    public void queryList() throws Exception {
        mockMvc.perform(get("/yibot/v1/api/feedbackback")).andExpect(status().isOk())
    ...
    public void query() throws Exception {
        ...
        Long id = 1L;
        mockMvc.perform(get("/yibot/v1/api/feedbackback/" + id)).andExpect(status().isOk())
    ...
    public void create() throws Exception {
        ...
        mockMvc.perform(post("/yibot/v1/api/feedbackback").accept(MediaType.APPLICATION_JSON).contentType(MediaType.APPLICATION_JSON)
        .content(JSONObject.toJSONString(feedbackBackTemp))).andExpect(status().isOk())
        .andExpect(jsonPath("code").value(resCodeProperties.getSuccessCode()))
        .andExpect(jsonPath("message").value(resCodeProperties.getSuccessMsg()))
        .andDo(MockMvcResultHandlers.print());
    }
    ...
    public void update() throws Exception {
        ...
        mockMvc.perform(put("/yibot/v1/api/feedbackback/" + id).accept(MediaType.APPLICATION_JSON).contentType(MediaType.APPLICATION_JSON)
        .content(JSONObject.toJSONString(feedbackBackTemp))).andExpect(status().isOk())
        .andExpect(jsonPath("code").value(resCodeProperties.getSuccessCode()))
        .andExpect(jsonPath("message").value(resCodeProperties.getSuccessMsg()))
        .andDo(MockMvcResultHandlers.print());
    ...
    @Transactional
    @Rollback
    public void deleteFeedbackBack() throws Exception {

        Long id = 1L;
        mockMvc.perform(delete("/yibot/v1/api/feedbackback/" + id)).andExpect(status().isOk())
