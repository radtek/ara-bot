...
import com.zhuiyi.model.CityOverviewId;
...
public interface CityOverviewRepository extends JpaRepository<CityOverview, CityOverviewId>, JpaSpecificationExecutor<CityOverview>, Serializable{
    /**
     * 按对象id查找对象
     * @param id 对象标识
     * @return 返回CityOverview对象
     */
    CityOverview findById(Long id);
     ...
     */
    @Modifying
    @Query(value="delete from CityOverview where id in (:ids)", nativeQuery = true)
